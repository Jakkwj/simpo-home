...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  s: () => (/* binding */ decodeNamedCharacterReference)
});
...
var mermaid_b0ad2de1 = __webpack_require__(29331);
...
/* harmony export */ });
/* harmony import */ var _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(29331);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(26312);
/* harmony import */ var _createText_3df630b5_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(36399);
/* harmony import */ var _svgDraw_0fcc813d_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(22689);
...
/* harmony export */ });
/* harmony import */ var _flowDb_6a57c1b4_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(33098);
...
/* harmony import */ var _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(29331);
...
/* harmony import */ var _styles_5f89df53_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(39315);
...
const addVertices = function(vert, g, svgId, root, _doc, diagObj) {
  ...
  keys.forEach(function(id) {
    ...
    const styles = (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.k)(vertex.styles);
    let vertexText = vertex.text !== void 0 ? vertex.text : vertex.id;
    let vertexNode;
    if ((0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.n)((0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.c)().flowchart.htmlLabels)) {
      const node = {
      ...
      const rows = vertexText.split(_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.e.lineBreakRegex);
      for (const row of rows) {
    ...
    _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.l.warn("Adding node", vertex.id, vertex.domId);
...
const addEdges = function(edges, g, diagObj) {
  ...
  if (edges.defaultStyle !== void 0) {
    const defaultStyles = (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.k)(edges.defaultStyle);
  ...
  edges.forEach(function(edge) {
    ...
    if (edge.style !== void 0) {
      const styles = (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.k)(edge.style);
      style = styles.style;
      labelStyle = styles.labelStyle;
    } else {
      switch (edge.stroke) {
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.o)(edge.interpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.o)(edges.defaultInterpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    } else {
      edgeData.curve = (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.o)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
      ...
      if ((0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.n)((0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.c)().flowchart.htmlLabels)) {
        ...
        edgeData.label = edge.text.replace(_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.e.lineBreakRegex, "\n");
        if (edge.style === void 0) {
...
const getClasses = function(text, diagObj) {
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.l.info("Extracting classes");
  diagObj.db.clear();
  try {
    diagObj.parse(text);
    return diagObj.db.getClasses();
  } catch (e) {
    _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.l.error(e);
    return {};
  }
};
const draw = function(text, id, _version, diagObj) {
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.l.info("Drawing flowchart");
  diagObj.db.clear();
  const { securityLevel, flowchart: conf2 } = (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  let sandboxElement;
  ...
  try {
    ...
    _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.l.debug("Parsing failed");
  }
  ...
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.l.warn("Get vertices", vert);
  ...
  for (i = subGraphs.length - 1; i >= 0; i--) {
    ...
    for (let j = 0; j < subG.nodes.length; j++) {
      _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.l.warn(
        "Setting subgraph",
        subG.nodes[j],
  ...
  (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_10__.p)(g, svg, conf2.diagramPadding, conf2.useMaxWidth);
  const keys = Object.keys(vert);
...
const diagram = {
  parser: _flowDb_6a57c1b4_js__WEBPACK_IMPORTED_MODULE_13__.p,
  db: _flowDb_6a57c1b4_js__WEBPACK_IMPORTED_MODULE_13__.f,
  renderer: _styles_5f89df53_js__WEBPACK_IMPORTED_MODULE_14__.f,
  styles: _styles_5f89df53_js__WEBPACK_IMPORTED_MODULE_14__.a,
  init: (cnf) => {
    if (!cnf.flowchart) {
      cnf.flowchart = {};
    }
    ...
    _flowDb_6a57c1b4_js__WEBPACK_IMPORTED_MODULE_13__.f.clear();
    _flowDb_6a57c1b4_js__WEBPACK_IMPORTED_MODULE_13__.f.setGen("gen-1");
  }
};
...
/* harmony import */ var _edges_49ac43a2_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3550);
/* harmony import */ var _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(29331);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(697);
/* harmony import */ var _createText_3df630b5_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(36399);
...
const adjustClustersAndEdges = (graph, depth) => {
  ...
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Adjusted Graph", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph));
  extractor(graph, 0);
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_4__.l.trace(clusterDb);
};
const extractor = (graph, depth) => {
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("extractor - ", depth, dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph), graph.children("D"));
  if (depth > 10) {
  ...
  for (const node of nodes) {
    ...
    graph.children(node) && graph.children(node).length > 0) {
      ...
      _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Old graph before copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph));
      ...
      _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("New graph after copy node: (", node, ")", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(clusterGraph));
      _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Old graph after copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph));
    } else {
      _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_4__.l.warn(
        "Cluster ** ",
        node,
...
const recursiveRender = async (_elem, graph, diagramtype, parentCluster) => {
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph in recursive render: XXX", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph), parentCluster);
  ...
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph after layout:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph));
  let diff = 0;
...
const render = async (elem, graph, markers, diagramtype, id) => {
  ...
  clear();
  clear$1();
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph at first:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph));
  adjustClustersAndEdges(graph);
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph after:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph));
...
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(697);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(26312);
/* harmony import */ var _flowDb_6a57c1b4_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(33098);
/* harmony import */ var _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(29331);
/* harmony import */ var _index_a92ac404_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(87229);
...
const addVertices = function(vert, g, svgId, root, doc, diagObj) {
  ...
  keys.forEach(function(id) {
    ...
    const styles = (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.k)(vertex.styles);
    let vertexText = vertex.text !== void 0 ? vertex.text : vertex.id;
    let vertexNode;
    _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.l.info("vertex", vertex, vertex.labelType);
    if (vertex.labelType === "markdown") {
      _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.l.info("vertex", vertex, vertex.labelType);
    } else {
      if ((0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.n)((0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.c)().flowchart.htmlLabels)) {
        const node = {
          label: vertexText.replace(
            /fa[blrs]?:fa-[\w-]+/g,
            (s) => `<i class='${s.replace(":", " ")}'></i>`
        ...
        const svgLabel = doc.createElementNS("http://www.w3.org/2000/svg", "text");
        svgLabel.setAttribute("style", styles.labelStyle.replace("color:", "fill:"));
        const rows = vertexText.split(_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.e.lineBreakRegex);
        for (const row of rows) {
          const tspan = doc.createElementNS("http://www.w3.org/2000/svg", "tspan");
          tspan.setAttributeNS("http://www.w3.org/XML/1998/namespace", "xml:space", "preserve");
          tspan.setAttribute("dy", "1em");
    ...
    g.setNode(vertex.id, {
      ...
      type: vertex.type,
      props: vertex.props,
      padding: (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.c)().flowchart.padding
    });
    _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.l.info("setNode", {
      labelStyle: styles.labelStyle,
      labelType: vertex.labelType,
      shape: _shape,
      labelText: vertexText,
...
const addEdges = function(edges, g, diagObj) {
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.l.info("abc78 edges = ", edges);
  let cnt = 0;
  let linkIdCnt = {};
  let defaultStyle;
  let defaultLabelStyle;
  if (edges.defaultStyle !== void 0) {
    const defaultStyles = (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.k)(edges.defaultStyle);
    defaultStyle = defaultStyles.style;
    defaultLabelStyle = defaultStyles.labelStyle;
  }
  edges.forEach(function(edge) {
    ...
    if (linkIdCnt[linkIdBase] === void 0) {
      ...
      _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    } else {
      linkIdCnt[linkIdBase]++;
      _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    }
    let linkId = linkIdBase + "-" + linkIdCnt[linkIdBase];
    _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.l.info("abc78 new link id to be used is", linkIdBase, linkId, linkIdCnt[linkIdBase]);
    const linkNameStart = "LS-" + edge.start;
    const linkNameEnd = "LE-" + edge.end;
    ...
    if (edge.style !== void 0) {
      const styles = (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.k)(edge.style);
      style = styles.style;
      labelStyle = styles.labelStyle;
    }
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.o)(edge.interpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.o)(edges.defaultInterpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    } else {
      edgeData.curve = (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.o)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
        edgeData.arrowheadStyle = "fill: #333";
    ...
    edgeData.label = edge.text.replace(_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.e.lineBreakRegex, "\n");
    if (edge.style === void 0) {
      edgeData.style = edgeData.style || "stroke: #333; stroke-width: 1.5px;fill:none;";
    }
    edgeData.labelStyle = edgeData.labelStyle.replace("color:", "fill:");
...
const getClasses = function(text, diagObj) {
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Extracting classes");
  diagObj.db.clear();
  try {
    diagObj.parse(text);
    return diagObj.db.getClasses();
...
const draw = async function(text, id, _version, diagObj) {
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Drawing flowchart");
  diagObj.db.clear();
  ...
  const { securityLevel, flowchart: conf2 } = (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.c)();
  const nodeSpacing = conf2.nodeSpacing || 50;
  const rankSpacing = conf2.rankSpacing || 50;
  let sandboxElement;
  if (securityLevel === "sandbox") {
  ...
  let subG;
  const subGraphs = diagObj.db.getSubGraphs();
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Subgraphs - ", subGraphs);
  for (let i2 = subGraphs.length - 1; i2 >= 0; i2--) {
    subG = subGraphs[i2];
    _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Subgraph - ", subG);
  ...
  const vert = diagObj.db.getVertices();
  const edges = diagObj.db.getEdges();
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Edges", edges);
  let i = 0;
  for (i = subGraphs.length - 1; i >= 0; i--) {
    subG = subGraphs[i];
    (0,d3__WEBPACK_IMPORTED_MODULE_1__/* .selectAll */ .Ubm)("cluster").append("text");
    for (let j = 0; j < subG.nodes.length; j++) {
      _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Setting up subgraphs", subG.nodes[j], subG.id);
  ...
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.u.insertTitle(svg, "flowchartTitleText", conf2.titleTopMargin, diagObj.db.getDiagramTitle());
  (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_2__.p)(g, svg, conf2.diagramPadding, conf2.useMaxWidth);
  diagObj.db.indexNodes("subGraph" + i);
  if (!conf2.htmlLabels) {
    const labels = doc.querySelectorAll('[id="' + id + '"] .edgeLabel .label');
    for (const label of labels) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   C: () => (/* binding */ decodeNumericCharacterReference)
/* harmony export */ });
/**
