...
- **Powerful and Flexible**: one can arbitrary combine the modles and datas only if the model&aposs components are the same as the data&aposs targets.
...
<div align="center" style={{marginTop: "0vh"}}>
  <img src={config.customFields.imgUrlIntroduction_1} width="100%"/>
</div>
...
<br />
<div align="center" style={{marginTop: "0vh"}}>
  <img src={config.customFields.imgUrlIntroduction_2} width="100%"/>
</div>
