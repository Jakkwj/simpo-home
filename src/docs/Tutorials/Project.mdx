...
<!-- As the final essential element of SIMPO,  -->
...
### <a id="way_2"></a>2. Import from Template

<!-- /template_file/Solution.xlsx -->

Import a Project from a: <a href={config.customFields.urlDownloadUrlplateProject} target="_blank" download>Project template xlsx file</a>

<!-- /img/quick_start/step4/2.gif -->
...
In Project, you can directly edit the corresponding BioModel and DataSet. Then, in the Solution tab, you can edit the solver parameters. After clicking the START button in the Calculation tab to begin the calculation, you will obtain the results.
