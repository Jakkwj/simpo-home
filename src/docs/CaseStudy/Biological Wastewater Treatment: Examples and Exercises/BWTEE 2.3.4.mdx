...
### Result
:::tip Tip
The measured data also come from the AQUASIM calculation, but with less result sampling rate. To increse the calculation speed, the sampling rate decrease from 1h/point to 5h/point.
...
**SIMPO** project for this example could be found in <a href="https://dash.simpowater.org/dashboard/projects/public/name/BWTEE%202.3.4%20Chemostat/id/414/did/409">BWTEE 2.3.4 Chemostat</a>.
