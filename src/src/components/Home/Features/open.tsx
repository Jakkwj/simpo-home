  ...
  return (
    ...
    >
      ...
      <Feature
        ...
        imgUrl={siteConfig.customFields.imgUrlOpen as string}
        // imgUrl="img/gif/import_biomodel.gif"
        title={<Translate id="home.open">Open-Minded</Translate>}
        description={
          <>
            <p>
              {/* {siteConfig.title} */}
            ...
            <ul>
              <li>
                <Translate>
                  {/* { 'The core source code is open-source, and everyone is encouraged to contribute code to co-create algorithms.' } */}
                  {
                    "Everyone is encouraged to contribute code to co-create algorithms."
                  }
                </Translate>
              </li>
              ...
              <li>
                ...
                <Translate>
                  ...
                  {`Works on Windows, Linux, and Mac, it can leverage the power of supercomputers, as their systems are usually Linux-based.`}
                </Translate>
              </li>
              ...
              <li>
                <Translate>
                  ...
                  Models, datasets and calculation results can be published in
                  public version to share the research findings to the entire
                  research community.
                </Translate>
              </li>
              ...
              {/* {siteConfig.title}
                  <Translate id="home.open.3">
                    {` provides OER to all researchers and students. This endeavor aligns with the United Nations' Sustainable Development Goal 4: Quality Education.`}
                  </Translate>
                </li> */}
            </ul>
          </>
