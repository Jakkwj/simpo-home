    ...
    >
      ...
      <Feature
        ...
        description={
          <>
            <p>
              <Translate>{`No way to cheat:`}</Translate>
            </p>

            <ul>
              <li>
                <Translate>
                  All results are calculated according to open-source code,
                  there is no possibility of modifying the calculation results.
                </Translate>
              </li>
