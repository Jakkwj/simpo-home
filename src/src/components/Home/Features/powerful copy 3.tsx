...
export default function FeaturesEasyToUse() {
  ...
  return (
    <div className="hero" style={{ marginTop: "-2vh" }}>
      <div className="container">
        <Feature
          ...
          title={
            <Translate id="home.powerful">Powerful and Flexible</Translate>
          }
          description={
            <>
              <p>
              ...
              <ul>
                <li>
                  ...
                  // id="home.powerful.3"
                  >
                    Calculation engines includes: simulation, sensitivity
                    analysis, uncertainty analysis and parameter estimation.
                  </Translate>
                </li>
                ...
                <li>
                  <Translate>
                    Models and data can be released in multiple versions, making
                    it easy to determine the optimal model structure and
                    parameter.
                  </Translate>
                </li>
