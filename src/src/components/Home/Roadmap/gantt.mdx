...
<Mermaid
  chart={`gantt
    ...
    Estimaiton Plotting                     :c4a01, after c4apH, 60d
    Uncertainty Plotting                    :c4a02, after c4apH, 60d
    PlugFlow Reactor                        :c4c, after c4a02, 60d
    ...
    Steady State                            :c4StedayState, after c5, 120d
