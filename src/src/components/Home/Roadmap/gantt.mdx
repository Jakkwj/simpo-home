...
<Mermaid
  chart={`gantt
    ...
    Steady State                            :done, c4StedayState, after b3a, 2026-04-10

    NSGA-II                                 :c4a03a, after c4StedayState, 60d
    10 Layer Settling Reactor               :b4Layer, after c4a03a, 30d
    BMS1                                    :b4BMS1, after b4Layer, 30d
    SCE-UA                                  :b4, after b4BMS1, 90d


    Automatic Evaluation                    :c4a04, after b4, 60d
    ...
    CFD Algorithm                           :c7, after c5a, 300d
