...
const config = {
  ...
  customFields: {
    ...
    urlDownloadClientWindows: 'https://gitee.com/Jakkwj/simpo-home/releases/download/package/SimpoClient_1.3.1.exe',
    urlDownloalClientUbuntu: 'https://gitee.com/Jakkwj/simpo-home/releases/download/package/SimpoClient_1.3.1_amd64.deb',
  ...
  themeConfig:
    ...
    ({
      ...
      announcementBar: {
        id: 'announcementBar',
        content:
          '<strong>🎉 <a target="_blank" rel="noopener noreferrer" href="http://www.simpowater.org/changelog/SIMPO%20Client/2026">SimpoClient v1.3.1</a> has been released!</strong>',
        isCloseable: true,
