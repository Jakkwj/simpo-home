...
const config = {
  ...
  customFields: {
    ...
    // urlDownloadClientWindows: 'https://github.com/Jakkwj/simpo-home/releases/download/v0.11.3/SimpoClient_installer.exe',
    // urlDownloalClientUbuntu: 'https://github.com/Jakkwj/simpo-home/releases/download/v0.11.3/SimpoClient_installer.sh',

    urlDownloadClientWindows: 'https://github.com/Jakkwj/simpo-home/releases/download/v0.11.3/SimpoClient_0.11.3.exe',
    urlDownloalClientUbuntu: 'https://github.com/Jakkwj/simpo-home/releases/download/v0.11.3/SimpoClient_0.11.3_amd64.deb',
  ...
  themeConfig:
    ...
    ({
      ...
      announcementBar: {
        id: 'announcementBar',
        content:
          '<strong>🎉 <a target="_blank" rel="noopener noreferrer" href="http://www.simpowater.org/changelog/SIMPO%20Client/2025">Simpo Client v0.11.3</a> has been released!</strong>',
        isCloseable: true,
