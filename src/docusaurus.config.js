...
const config = {
  ...
  customFields: {
    ...
    urlDownloadClientWindows: 'https://github.com/Jakkwj/simpo-home/releases/download/v0.8.0/SimpoClient_installer.exe',
    urlDownloalClientUbuntu: 'https://github.com/Jakkwj/simpo-home/releases/download/v0.8.0/SimpoClient_installer.sh',
