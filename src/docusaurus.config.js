...
const config = {
  ...
  customFields: {
    ...
    urlDownloadClientWindows: 'https://github.com/Jakkwj/simpo-home/releases/download/v0.9.1/SimpoClient_installer.exe',
    urlDownloalClientUbuntu: 'https://github.com/Jakkwj/simpo-home/releases/download/v0.9.1/SimpoClient_installer.sh',
  ...
  themeConfig:
    ...
    ({
      ...
      announcementBar: {
        id: 'announcementBar',
        content:
          '<strong>🎉 <a target="_blank" rel="noopener noreferrer" href="http://www.simpowater.org/changelog/SIMPO%20Client/2025">Simpo Client v0.9.1</a> has been released!</strong>',
        isCloseable: true,
