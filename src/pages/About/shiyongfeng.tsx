...
export default function AboutShiYongFeng() {
    ...
    >
      ...
      <div className="container" >
        ...
        <Feature
          ...
          title={<Translate id="about.shiyongfeng">Yong-Feng Shi</Translate>}
          description={
            <>
              <p>
                <Translate
                >
                  ...
                  { 'Master in Environmental Engineering from Guangzhou University, focusing on standard research, business intelligence and enterprise information system development.' }
                </Translate>
              </p>
              {/* <ul>
                <li>
