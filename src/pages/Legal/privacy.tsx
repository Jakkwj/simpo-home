    ...
    >
      ...
      <main>
        ...
        >
          ...
          <h1 style={{marginTop: '0vh', marginBottom: '-0vh', textAlign: 'left', marginLeft: '18vw'}} className="hero__title">Privacy Policy of SIMPO</h1>
          ...
          <li>
          <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to SIMPO.</p>
          </li>
          <li>
          ...
          <li>
          <p><strong>Website</strong> refers to SIMPO, accessible from <a href="https://www.simpowater.org/" rel="external nofollow noopener" target="_blank">https://www.simpowater.org</a></p>
          </li>
          <li>
