...
- Improved
  ...
  - Replace `dataInflowOpen` with `inflowGetterDict[inflowNameOpen][tankTypeDict[inflowNameOpen]]`.
  - Replace `dataflowOpen` with `flowGetterDict[flowNameOpen][tankTypeDict[flowNameOpen]]`.
...
- Fixed
  ...
  - While leave the Detial page of BioModel/DataSet/Project,the page won't ask if nothing changed.
